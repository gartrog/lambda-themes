...
;;;;; Default
     ...
     `(hl-line              ((,class (:background ,lambda-highlight :extend t))))
...
;;;;; Built-in syntax (Font-Lock)
     ...
     `(font-lock-keyword-face        ((,class (:foreground ,lambda-yellow :slant ,(if lambda-themes-set-italic-keywords 'italic 'normal)))))
     `(font-lock-string-face         ((,class (:foreground ,lambda-aqua))))
     `(font-lock-variable-name-face  ((,class (:foreground ,lambda-crucial))))
     ...
     `(font-lock-number-face         ((,class (:foreground ,lambda-yellow :weight medium))))
...
;;;;;; Org Base Theme
     ...
     `(org-block                                    ((,class (:background ,lambda-highlight :foreground ,lambda-meek))))
     `(org-block-begin-line                         ((,class (:background ,lambda-ultralight :foreground ,lambda-meek))))
     `(org-block-end-line                           ((,class (:background ,lambda-ultralight :foreground ,lambda-meek))))
     ...
     `(org-code                                     ((,class (:foreground ,lambda-yellow))))
     ...
     `(org-document-title                           ((,class (:inherit ,(if lambda-themes-set-variable-pitch 'variable-pitch 'default) :height 2.0 :foreground ,lambda-fg :weight medium))))
     ...
     `(org-verbatim                                 ((,class (:foreground ,lambda-blue))))
